...
<head>
    ...
    <!-- Commented out external CSS to prevent conflicts since styles are inline below -->
    ...
    <header class="header" id="header">
        ...
        <div class="header-top">
            <div class="header-avatar">
                <!-- Note: Filenames with spaces are risky on some servers. Renaming to 'Portfolio_logo.png' is safer. -->
            ...
            <div class="skills-categories reveal">
                ...
                <div class="skill-category">
                    ...
                    <div class="skill-tags">
                        ...
                        <span class="tag">OOP Programming</span>
        ...
        <section class="contact" id="contact">
            ...
            <div class="contact-wrapper reveal">
                ...
                <form class="contact-form" id="contact-form" novalidate>
                    ...
                    <div class="form-row">
                        <!-- Added ID and Aria-Label for accessibility -->
                        <input type="text" id="input-name" name="name" placeholder="Your Name" class="form-box" required aria-label="Your Name">
                        <input type="email" id="input-email" name="email" placeholder="Your Email" class="form-box" required aria-label="Your Email">
                    </div>
                    <input type="text" id="input-subject" name="subject" placeholder="Subject" class="form-box" required aria-label="Subject">
                    <textarea id="input-message" name="message" class="form-box" rows="6" placeholder="Your Message" required aria-label="Your Message"></textarea>
                ...
                <div class="form-message" id="contact-message-ajax" style="display:none;" role="alert" aria-live="polite"></div>
            </div>
        </section>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- FIX: Added missing contact form variables ---
    const contactForm = document.getElementById('contact-form');
    const contactBtn = document.getElementById('contact-submit-btn');
    const contactMsg = document.getElementById('contact-message-ajax');
    ...
    // Check if elements exist (fix for ReferenceError)
    if (contactForm && contactBtn && contactMsg) {
        contactForm.addEventListener('submit', function (e) {
            ...
            // Changed to relative path to work on subfolders
